...
// PANEL3
// ======
this.disableCustomTextFormatsCB = panel3.add("checkbox", undefined, undefined, {name: "disableCustomTextFormatsCB"});
    this.disableCustomTextFormatsCB.text = "Disable Custom Text Formats";
    this.disableCustomTextFormatsCB.helpTip = "If true, All text will be formatted ONLY by configurations above"
    this.disableCustomTextFormatsCB.value = true;
